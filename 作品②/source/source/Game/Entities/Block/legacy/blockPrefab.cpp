...
void InitBlockPrefab(void)
{
...

    {
        ...
        );
        {
            ...
            sadat->pos3D = MkF3(0.0f, 0.0f, BLOCK_HIGHT * 20.0f);
            sadat->rot3D = MkF3(80.0f, 0.0f, 0.0f);

            sadat->size.x = 999.0f * 8.0f;
            sadat->size.y = 1013.0f * 8.0f;
    ...
    }
    {
        ...
        );
        {
            ...
            sadat->size.x = 252.0f * 8.0f;
            sadat->size.y = 705.0f * 8.0f;
    ...
    }
    {
        ...
        );
        {
            ...
            sadat->size.x = 961.0f * 8.0f;
            sadat->size.y = 880.0f * 8.0f;
    ...
    }
    {
        ...
        );
        {
            ...
            sadat->pos3D = MkF3(0.0f, 0.0f, BLOCK_HIGHT * -5.0f);
            sadat->rot3D = MkF3(80.0f, 0.0f, 0.0f);

            sadat->size.x = 560.0f * 8.0f;
            sadat->size.y = 791.0f * 8.0f;
    ...
    }
    {
        ...
        );
        {
            ...
            sadat->size.x = 429.0f * 8.0f;
            sadat->size.y = 297.0f * 8.0f;
    ...
    }
    {
        ...
        );
        {
            ...
            sadat->size.x = 203.0f * 8.0f;
            sadat->size.y = 91.0f * 8.0f;
    ...
    }
    {
        ...
        );
        {
            ...
            sadat->pos3D = MkF3(0.0f, 0.0f, BLOCK_HIGHT * -25.0f);
            sadat->rot3D = MkF3(80.0f, 0.0f, 0.0f);

            sadat->size.x = 208.0f * 6.0f;
            sadat->size.y = 635.0f * 6.0f;
