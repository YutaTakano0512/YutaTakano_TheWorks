...
#define CAMERA_SHAKE_SMALL_POWER	(4.0f * 2.0f)

#define CAMERA_SHAKE_MIDIUM_FRAME	(25)
#define CAMERA_SHAKE_MIDIUM_POWER	(8.0f * 2.0f)

#define CAMERA_SHAKE_LARGE_FRAME	(35)
#define CAMERA_SHAKE_LARGE_POWER	(16.0f * 2.0f)

#define CAMERA_SHAKE_EXLARGE_FRAME	(60)
#define CAMERA_SHAKE_EXLARGE_POWER	(32.0f * 2.0f)
...
void CameraShakeRequestAll(int frame, float power, float powerY = -1.0f);
void CameraShakeRequest(int index, int frame, float power, float powerY = -1.0f);
