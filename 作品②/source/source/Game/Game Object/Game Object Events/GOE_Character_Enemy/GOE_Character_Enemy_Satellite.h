// ===================================================
// GOE_Character_Enemy_Satellite.h キャラクターオブジェクト
// 
// hara sougo  2025/04/06
// ===================================================
#ifndef _GOE_CHILD_CHARACTER_ENEMY_SATELLITE_H_
#define _GOE_CHILD_CHARACTER_ENEMY_SATELLITE_H_
...
class GOE_Character_Enemy_Satellite : public GOE_Character_Enemy
{
...
private:
    ...
    static constexpr int ATTACK_BEAM_BEFORE_FIXED_FRAME = 30;
    static constexpr int ATTACK_BEAM_ATTACKING_FRAME = 50;

    static constexpr int FRAME_BEAM_SHOOT_END = 30;
    static constexpr int FRAME_BEAM_AFTER = 20;

    static constexpr int FRAME_BEAM_LIFETIME = 300;

    static constexpr int MODEL_NUM = 8;
    static constexpr float MODEL_SCA = 4.0f;
...
protected:
    int m_InstanceID = 0;
    Float3 m_StartingPosBuf = {};
    int m_StartedFrameCount = 0;
    int m_LifeTimeMax = FRAME_ONE_SECOND * 18.0f;
    ...
    DPD_SHADER_TYPE m_shaderType = DPD_SHADER_TYPE_METAL_ENEMY_2;

    Float3 m_ModelArmorTransRot[4] = {};
    Float3 m_ModelEdgeTransRot[3] = {};
...
public:
    static constexpr const char* CHARACTER_NAME = "ENEMY_SATELLITE";

    GOE_Character_Enemy_Satellite(GAME_OBJECT* obj) : SuperGOE(obj) {}
	~GOE_Character_Enemy_Satellite() {};
