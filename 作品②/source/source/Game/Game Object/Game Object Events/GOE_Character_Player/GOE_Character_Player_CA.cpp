...
void GOE_Character_Player_CA::Init()
{
    ...
    m_TexIconSub = LoadTexData("TEX/ui/in_game_master/consept_icon");
    ...
    m_Tex_Main_Attack[0] = LoadTexData("TEX/player/kai/attack/kai_attack_01");
    m_Tex_Main_Attack[1] = LoadTexData("TEX/player/kai/attack/kai_attack_02");
    m_Tex_Main_Attack[2] = LoadTexData("TEX/player/kai/attack/kai_attack_03");
    m_Tex_Main_Attack[3] = LoadTexData("TEX/player/kai/attack/kai_attack_04");
    m_Tex_Main_Attack[4] = LoadTexData("TEX/player/kai/attack/kai_attack_05");
    m_Tex_Main_Attack[5] = LoadTexData("TEX/player/kai/attack/kai_attack_06");
    m_Tex_Main_Attack[6] = LoadTexData("TEX/player/kai/attack/kai_attack_07");
    m_Tex_Main_Attack[7] = LoadTexData("TEX/player/kai/attack/kai_attack_08");

    m_Tex_Main_Walk[0] = LoadTexData("TEX/player/kai/move/kai_walk_01");
    m_Tex_Main_Walk[1] = LoadTexData("TEX/player/kai/move/kai_walk_02");
    m_Tex_Main_Walk[2] = LoadTexData("TEX/player/kai/move/kai_walk_03");
    m_Tex_Main_Walk[3] = LoadTexData("TEX/player/kai/move/kai_walk_04");
    m_Tex_Main_Walk[4] = LoadTexData("TEX/player/kai/move/kai_walk_05");
    m_Tex_Main_Walk[5] = LoadTexData("TEX/player/kai/move/kai_walk_06");
    m_Tex_Main_Walk[6] = LoadTexData("TEX/player/kai/move/kai_walk_07");
    m_Tex_Main_Walk[7] = LoadTexData("TEX/player/kai/move/kai_walk_08");

    m_Tex_Main_Draw[0] = LoadTexData("TEX/player/kai/kako/kai_skill_01");
    m_Tex_Main_Draw[1] = LoadTexData("TEX/player/kai/kako/kai_skill_02");
    m_Tex_Main_Draw[2] = LoadTexData("TEX/player/kai/kako/kai_skill_03");
    m_Tex_Main_Draw[3] = LoadTexData("TEX/player/kai/kako/kai_skill_04");
    m_Tex_Main_Draw[4] = LoadTexData("TEX/player/kai/kako/kai_skill_05");
    m_Tex_Main_Draw[5] = LoadTexData("TEX/player/kai/kako/kai_skill_06");
    m_Tex_Main_Draw[6] = LoadTexData("TEX/player/kai/kako/kai_skill_07");
    m_Tex_Main_Draw[7] = LoadTexData("TEX/player/kai/kako/kai_skill_08");

    m_Tex_Main_Idle = LoadTexData("TEX/player/kai/kai_idle");
    ...
    m_KakoDatList[0].dat.graphic = KAKOPON_GRAPHIC::Main_Ca;
    m_KakoDatList[0].dat.type = KAKOPON_TYPE::Main;
    m_KakoDatList[0].dat.frameMax = KAKOPON_COOLDOWN_FRAME;

    m_KakoDatList[1].dat.graphic = KAKOPON_GRAPHIC::DeBuff;
			...
			{ //ループアニメーション更新
                ...
                else if (m_IsWalking)
                {
                    ...
                    if ((m_CharaData->playingMotion.motion->name) == animName)
                    {
                        ...
                        m_Obj->graphic.graph.scale.y = 1.0f;
                        m_Obj->graphic.pos3d = m_GraphPosDefault;
                        GraphicSpriteSet(m_Tex_Main_Walk[std::max(m_CurrentAxisEx - 1, 0)], 4, 3);
                    }
                }
                else
                {
                        ...
                        && (m_CharaData->playingMotion.motion->name) == animName)
                    {
                        ...
                        m_Obj->graphic.graph.scale.y = 1.0f;
                        m_Obj->graphic.pos3d = m_GraphPosDefault;
                        GraphicSpriteSet(m_Tex_Main_Idle, 3, 3);
                    }
                }
        ...
        {
            {
                ...
                //dsdat.color = { 0.1f, 0.1f, 0.5f, 1.0f };
                dsdat.color = { 1.0f, 0.8f, 0.5f, 1.0f };
...
void GOE_Character_Player_CA::SetDownPoseStart()
{
    m_DefeatFrameAnimMax = 6;
}

void GOE_Character_Player_CA::SetDownPose()
{
    //モーション再生
    GraphicSpriteSet(
        m_Tex_Main_Down,
...
void GOE_Character_Player_CA::SetCharaSubGraphic()
{
}
